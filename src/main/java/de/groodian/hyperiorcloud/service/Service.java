...
import de.groodian.hyperiorcloud.util.FileUtil;
import java.io.File;
...
public abstract class Service {
    ...
    protected void checkFilesHelper(List<String> missingFiles, String fileName) {
    ...
    private boolean start() {
        ...
        try {
            ...
            process = new ProcessBuilder().command(startArguments)
